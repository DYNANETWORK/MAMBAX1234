...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "SUKHIMUSIC_2_GBOT"
    usar = user
    wew = usar.id
    try:
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALL:
        await message.reply_text("**⚡SUKHI MUSIC⚡ мυѕι¢ \n ησтнιηg ρℓαуιηg ...**")
    else:
